...
from ..types.task_uploaded_file_response import TaskUploadedFileResponse
...
from .types.contenttype import Contenttype
    ...
    def user_upload_file_presigned_url(
        ...
        *,
        ...
        _response = self._raw_client.user_upload_file_presigned_url(
            file_name=file_name, content_type=content_type, size_bytes=size_bytes, request_options=request_options
        )
        return _response.data

    def get_task_user_uploaded_file_presigned_url(
        self, task_id: str, file_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> TaskUploadedFileResponse:
        """
        ...
        """
        _response = self._raw_client.get_task_user_uploaded_file_presigned_url(
...
class AsyncFilesClient:
    ...
    async def get_task_user_uploaded_file_presigned_url(
        self, task_id: str, file_id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> TaskUploadedFileResponse:
        """
        Get secure download URL for a user uploaded file used in the task.
        ...
        async def main() -> None:
            await client.files.get_task_user_uploaded_file_presigned_url(
                task_id="task_id",
                file_id="file_id",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.get_task_user_uploaded_file_presigned_url(
            task_id, file_id, request_options=request_options
        )
        return _response.data
