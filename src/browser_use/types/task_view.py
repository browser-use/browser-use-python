...
from .task_session_view import TaskSessionView
...
class TaskView(UncheckedBaseModel):
    ...
    user_uploaded_files: typing_extensions.Annotated[typing.List[FileView], FieldMetadata(alias="userUploadedFiles")]
