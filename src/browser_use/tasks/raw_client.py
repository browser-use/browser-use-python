...
class RawTasksClient:
    ...
    def create_task(
        ...
        *,
        ...
        included_file_names: typing.Optional[typing.Sequence[str]] = OMIT,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "includedFileNames": included_file_names,
                "metadata": metadata,
                "secrets": secrets,
                "allowedDomains": allowed_domains,
                "persistenceProfileId": persistence_profile_id,
                "agent": convert_and_respect_annotation_metadata(
                    object_=agent, annotation=AgentSettings, direction="write"
                ),
                "proxy": convert_and_respect_annotation_metadata(
                    object_=proxy, annotation=ProxySettings, direction="write"
                ),
                "browser": convert_and_respect_annotation_metadata(
                    object_=browser, annotation=BrowserSettings, direction="write"
                ),
