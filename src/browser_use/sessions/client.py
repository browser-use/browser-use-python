...
class SessionsClient:
    ...
    def create_session(
        ...
        *,
        ...
        """
        _response = self._raw_client.create_session(profile_id=profile_id, proxy=proxy, request_options=request_options)
        return _response.data
    ...
    async def create_session(
        ...
        *,
        ...
        _response = await self._raw_client.create_session(
            profile_id=profile_id, proxy=proxy, request_options=request_options
        )
        return _response.data
