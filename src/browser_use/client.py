...
class BrowserUse:
    ...
    environment : typing.Optional[BrowserUseEnvironment]
    ...
    def __init__(
        ...
        *,
        ...
        environment: typing.Optional[BrowserUseEnvironment] = None,
        api_key: str,
...
def _get_base_url(
    *, base_url: typing.Optional[str] = None, environment: typing.Optional[BrowserUseEnvironment] = None
) -> str:
